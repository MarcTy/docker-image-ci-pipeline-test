...
import { UseSettingsGlobalState, DEFAULT_TELEMETRY_ADDRESS_URL, DEFAULT_TELEMETRY_FETCH_INTERVAL, DEFAULT_TELEMETRY_QOS} from '../../src/context/SettingsContext.jsx';
import TelemetryServerSetup from '../../src/components/settings/TelemetryServerSetup';
...
vi.mock('../../src/context/SettingsContext.jsx', () => ({
    ...
    DEFAULT_TELEMETRY_FETCH_INTERVAL: '',
...
describe('TelemetryServerSetup', () => {
    it('Renders with default props', () => {
        ...
        expect(screen.getByPlaceholderText(/5/i)).not.toBeNull();
    ...
    it('resets to default values on Reset button click', () => {
        ...
        expect(dispatchMock).toHaveBeenCalledWith({
            ...
            payload: { 
                ...
                telemetry_interval: DEFAULT_TELEMETRY_FETCH_INTERVAL, 
